// shared/themeSanitizer.mjs
// Runtime theme sanitizer shared by ESM serverless handlers.
...
export const FALLBACK_AI_DUAL_THEME = {
...
export const normalizeThemeHexColor = (value, fallback, hardFallback = '#ffffff') => (
...
export const sanitizeTheme = (value, fallbackTheme) => {
...
export const sanitizeDualTheme = (value, fallbackTheme = FALLBACK_AI_DUAL_THEME) => {
  const source = isRecord(value) ? value : {};
  return {
