...
export const applySyncedVisualSettings = (
    ...
    if (settings.visualizerTunings === undefined && settings.fusionTuning !== undefined) state.handleSetFusionTuning(settings.fusionTuning as Parameters<SettingsUiState['handleSetFusionTuning']>[0]);
