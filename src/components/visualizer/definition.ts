...
export type VisualizerTuningKind = 'none' | 'classic' | 'cadenza' | 'partita' | 'fume' | 'fusion' | 'claddagh' | 'cappella' | 'tilt' | 'monet' | 'diorama' | 'pendolo' | 'sonnet' | 'tempera';
...
export interface VisualizerSettingsResetProps {
    ...
    setDraftFusionTuning?: (tuning: FusionTuning) => void;
}
