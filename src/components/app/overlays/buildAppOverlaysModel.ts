...
export const buildAppOverlaysModel = ({
    ...
    const playbackNeighbors = currentSong
    ...
    floatingControls: currentSong
        ? {
            ...
            trackNavigation: {
                ...
                canPrev: playbackNeighbors!.prev.canGo && !isNowPlayingControlDisabled,
                canNext: playbackNeighbors!.next.canGo && !isNowPlayingControlDisabled,
                prevTitle: playbackNeighbors!.prev.title,
                nextTitle: playbackNeighbors!.next.title,
