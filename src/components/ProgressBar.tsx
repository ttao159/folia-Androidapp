...
const ProgressBar: React.FC<ProgressBarProps> = ({
    ...
    return (
        <div className="flex items-center gap-3 w-full select-none">
            ...
            <div className={`relative h-1.5 landscape:h-2 flex-1 rounded-sm md:rounded-full flex items-center group ${disabled ? 'cursor-not-allowed opacity-60' : 'cursor-pointer'}`} style={{ backgroundColor: trackColor }}>
                <div
                    ref={progressRef}
