    ...
    const applyImportedConfig = (config: any, keys: string[]) => {
        ...
        try {
            ...
            if (!config.visualizerTunings) {
                ...
                if (has('fusionTuning') && config.fusionTuning) store.handleSetFusionTuning(config.fusionTuning);
            }
    ...
    return (
        <div className="space-y-6">
            ...
            <section>
                ...
                <div className={`p-4 landscape:p-3 rounded-xl border space-y-4 landscape:space-y-3 ${settingsCardClass}`}>
                    ...
                    <div className={`p-3 landscape:p-2.5 rounded-xl border space-y-3 landscape:space-y-2.5 ${settingsCardClass}`}>
                    ...
                    <div className={`p-3 landscape:p-2.5 rounded-xl border flex items-center justify-between gap-3 landscape:gap-2 ${settingsCardClass}`}>
                        <div className="space-y-1">
                            <div className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
