...
export default {
  ...
  "status": {
    ...
    "playbackFailed": "播放失败",
    "providerPlaybackUnsupported": "{{provider}} 暂不支持在线播放",
  ...
  "commandPalette": {
    ...
    "pickerDescription": {
      "visualizer": {
        ...
        "fusion": "报章纸面之上，歌词以字级层次入场、唱后散开，带装饰巨字与墨晕落纸"
      },
      "background": {
    ...
    "commands": {
      ...
      "visualizer-fusion": { "title": "切换到可视化：交融", "description": "切换到交融字级动画 PV 可视化" },
  ...
  "home": {
    ...
    "loginTitleQishui": "使用抖音APP扫码",
    "loginNoteQishui": "打开抖音APP扫描二维码",
  ...
  "options": {
    ...
    "temperaToggleOff": "关闭",
    "fusionSettings": "交融参数",
    "fusionSettingsDesc": "调整交融的字级层次、唱后散开、墨晕与报章背景。",
    "fusionCameraIntensity": "镜头运动强度",
    "fusionHeroScale": "字级层次对比",
    "fusionGlyphMotion": "逐字动势",
    "fusionReleaseSpread": "唱后散开幅度",
    "fusionInkReveal": "墨晕落纸强度",
    "fusionShowDecor": "装饰巨字",
    "fusionShowHalo": "报章光环",
    "fusionTextureResolution": "渲染分辨率",
    "decorNone": "无",
    "decorSubtle": "半透明",
    "decorFull": "完整",
