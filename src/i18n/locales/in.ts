...
export default {
  ...
  "status": {
    ...
    "providerPlaybackUnsupported": "{{provider}} belum mendukung pemutaran online",
  ...
  "ui": {
    ...
    "enterLandscape": "Putar lanskap",
    "exitLandscape": "Keluar lanskap",
    "hideProgressBar": "Sembunyikan bilah kemajuan",
    "showProgressBar": "Tampilkan bilah kemajuan",
  ...
  "home": {
    ...
    "loginTitleQishui": "Pindai dengan Douyin",
    "loginNoteQishui": "Buka aplikasi Douyin dan pindai kode QR ini",
