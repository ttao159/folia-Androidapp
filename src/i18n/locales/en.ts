...
export default {
  "notifications": {
    ...
    "fusionReset": "Fusion tuning reset",
  ...
  "status": {
    ...
    "providerPlaybackUnsupported": "{{provider}} does not support online playback",
  ...
  "commandPalette": {
    ...
    "pickerDescription": {
      "visualizer": {
        ...
        "fusion": "Over a newspaper print ground, lyrics enter with a per-glyph scale hierarchy and release outward, with giant decorative glyphs and ink-on-paper blur"
      },
      "background": {
    ...
    "commands": {
      ...
      "visualizer-fusion": { "title": "Visualizer: Fusion", "description": "Switch to the Fusion glyph-animation lyric PV" },
  ...
  "ui": {
    ...
    "enterLandscape": "Landscape playback",
  ...
  "home": {
    ...
    "loginTitleQishui": "Scan with Douyin",
    "loginNoteQishui": "Open the Douyin app and scan this QR code",
  ...
  "options": {
    ...
    "fusionSettingsDesc": "Tune Fusion's glyph hierarchy, release spread, ink reveal and newspaper ground.",
    "fusionCameraIntensity": "Camera Intensity",
    "fusionHeroScale": "Glyph Scale Contrast",
    "fusionGlyphMotion": "Glyph Motion",
    "fusionReleaseSpread": "Release Spread",
    "fusionInkReveal": "Ink Reveal",
    "fusionShowDecor": "Decorative Glyphs",
    "fusionShowHalo": "Print Halo",
    "fusionTextureResolution": "Texture Resolution",
    "decorNone": "None",
    "decorSubtle": "Subtle",
    "decorFull": "Full",
